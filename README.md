...
|------|-------------|--------------|
| `figures/Figure1.pdf` | NES scatter, TCGA vs. METABRIC msVIPER results | `compare_kbhb_mrs.R` |
...
| `figures/FigureS3.pdf` | Sankey diagram: TMR regulons → DE Kbhb gene categories | `circos_tmr_kbhb.R` |
