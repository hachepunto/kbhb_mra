...
ggsave("figures/fig_sankey_tmr_kbhb.pdf", fig_sankey, width = 10, height = 7)
ggsave("figures/fig_sankey_tmr_kbhb.png", fig_sankey, width = 10, height = 7, dpi = 300)
message("figures/fig_sankey_tmr_kbhb.pdf + .png saved")
